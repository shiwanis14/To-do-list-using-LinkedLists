...
class ToDoList
{
  ...
  public:
      ...
      ToDoList(const char *task, int priority); // Class constructor 2
      ...
      void Insert(const char *task,int priority);// Add a task to the list
      void Delete(int priority);          // Delete given a priority
      void Delete(const char *task);            // Delete given a task string
